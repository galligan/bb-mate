...
authenticated removal attempt returned E400 because the registry requires the
tag. Do not intentionally repoint it in later alpha work. Publication itself
