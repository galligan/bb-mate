# Plugin Workbench goal references
...
- `.agents/plans/2026-08-10-plugin-workbench-runtime.md`
- `apps/cli/src/bin.ts`
...
- Browser control/capture and generic thread objects: local reviewed proposal
  drafts until an upstream issue exists; do not submit during this goal.
- Existing upstream-dependent BB Mate issues: #41–#46

## Public technical references

- Bun standalone executables: https://bun.sh/docs/bundler/executables
- Model Context Protocol server: https://modelcontextprotocol.io/specification/2025-11-25/server/index
- Model Context Protocol tools: https://modelcontextprotocol.io/specification/2025-11-25/server/tools

## Review scratch paths

- Standing: `.agents/goals/2026-08-10-plugin-workbench/tmp/reviews/standing/`
- Targeted: `.agents/goals/2026-08-10-plugin-workbench/tmp/reviews/targeted-<milestone>/`
- Full stack: `.agents/goals/2026-08-10-plugin-workbench/tmp/reviews/full-stack/`
