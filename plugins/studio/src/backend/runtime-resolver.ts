...
export interface RuntimeArtifactStamp {
  ...
  readonly artifact: "bb-plugin-studio-runtime";
...
function validStamp(value: RuntimeArtifactStamp): boolean {
  return (
    ...
    value.artifact === "bb-plugin-studio-runtime" &&
...
function manifestStamp(
  ...
  return {
    ...
    artifact: manifest.artifact as "bb-plugin-studio-runtime",
...
export async function resolvePackagedRuntime(options: {
  ...
  try {
    ...
    executablePath = fileURLToPath(
      new URL("../runtime/darwin-arm64/bb-plugin-studio-runtime", moduleUrl),
    );
